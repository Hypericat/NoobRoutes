...
object EditUI : Screen() {
    ...
    override fun draw() {
        ...
        roundedRectangle(originX, originY, 600, 70,titlePanelColor, titlePanelColor, Color.TRANSPARENT, 0, 20f, 20f, 0f, 0f, 0f)
        roundedRectangle(originX, originY, 600, currentY, buttonColor, radius = 20)
